...
if __name__ == "__main__":
    ...
    ind=dev.index('98:D3:33:80:D2:43')
    soc.connect((dev[ind],port))
    while(True):
        ...
        if len(faces) > 0:
            ...
            bestFit = {}
            for filename in os.listdir("/home/karthik_udupa/projects/opPro/newSeries/StoredImages"):
                if filename.endswith(".jpeg"):
                    try:
                        ...
                        bestFit[filename] = results
                        if results[0]:
                            print("Face matched with " + filename)
